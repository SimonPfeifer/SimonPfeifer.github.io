...
active: True
---
import cow_outline from "./cow_outline.jpg";
import cows_blob from "./cows_blob.jpg";
import cows_no_blob from "./cows_no_blob.jpg"
...
<img src={cow_outline.src} alt="Medial axis thinning applied to cow silhouette." width="70%" />
</div>
...
<div class="flex justify-center">
<img src={cows_blob.src} alt="Medial axis thinning applied to cosmic web." width="70%" />
</div>
...
<div class="flex justify-center">
<img src={cows_no_blob.src} alt="Medial axis thinning applied to cosmic web." width="70%" />
</div>
